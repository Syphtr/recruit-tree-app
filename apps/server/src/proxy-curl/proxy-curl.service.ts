...
export class ProxyCurlService {
  ...
  async cleanDb() {
    Promise.all([
      this.prisma.volunteerWork.deleteMany(),
      this.prisma.accomplishmentOrg.deleteMany(),
      this.prisma.article.deleteMany(),
      this.prisma.certification.deleteMany(),
      this.prisma.course.deleteMany(),
      this.prisma.education.deleteMany(),
      this.prisma.group.deleteMany(),
      this.prisma.honourAward.deleteMany(),
      this.prisma.language.deleteMany(),
      this.prisma.patent.deleteMany(),
      this.prisma.peopleAlsoViewed.deleteMany(),
      this.prisma.publication.deleteMany(),
      this.prisma.similarProfile.deleteMany(),
      this.prisma.testScore.deleteMany(),
      this.prisma.volunteerWork.deleteMany(),
      this.prisma.experience.deleteMany(),
      this.prisma.project.deleteMany(),
      this.prisma.profile.deleteMany(),
    ]).finally(() => this.prisma.profile.deleteMany());
  }
}
